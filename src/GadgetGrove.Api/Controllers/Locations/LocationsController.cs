...
namespace GadgetGrove.Api.Controllers.Locations;
...
public class LocationsController : BaseController
{
    ...
    public async Task<IActionResult> InsertAsync([FromBody] LocationForCreationDto dto)
        => Ok(await _locationService.AddAsync(dto));
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> UpdateAsync([FromRoute] long id, [FromBody] LocationForCreationDto dto)
