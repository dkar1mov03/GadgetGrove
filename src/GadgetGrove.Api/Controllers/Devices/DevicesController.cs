...
namespace GadgetGrove.Api.Controllers.Devices;
...
public class DevicesController : BaseController
{
    ...
    [HttpPost]
    public async Task<IActionResult> InsertAsync([FromForm] DeviceForCreationDto dto)
        => Ok(await _deviceService.AddAsync(dto));
    ...
    public async Task<IActionResult> GetAllAsync([FromQuery] PaginationParams @params)
        => Ok(await _deviceService.RetrieveAllAsync(@params));
    ...
    public async Task<IActionResult> DeleteAsync([FromRoute] long id)
        => Ok(await _deviceService.RemoveAsync(id));
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> UpdateAsync([FromRoute] long id, [FromForm] AudioVideoForUpdateDto dto)
        => Ok(await  _deviceService.ModifyAsync(id, dto));
