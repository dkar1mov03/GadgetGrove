...
namespace GadgetGrove.Api.Controllers.Accessories;
...
public class AccessoriesController : BaseController
{
    ...
    [HttpPost]
    public async Task<IActionResult> InsertAsync([FromForm] AccessoryForCreationDto dto)
        => Ok(await _accessoryService.AddAsync(dto));
    ...
    public async Task<IActionResult> GetAllAsync([FromQuery] PaginationParams @params)
        => Ok(await _accessoryService.RetrieveAllAsync(@params));
    ...
    public async Task<IActionResult> GetByIdAsync([FromRoute] long id)
        => Ok(await _accessoryService.RetrieveByIdAsync(id));
    ...
    public async Task<IActionResult> DeleteAsync([FromRoute] long id)
        => Ok(await _accessoryService.RemoveAsync(id));
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> UpdateAsync([FromRoute] long id, [FromForm] AccessoryForUpdateDto dto)
        => Ok(await _accessoryService.ModifyAsync(id, dto));
}
