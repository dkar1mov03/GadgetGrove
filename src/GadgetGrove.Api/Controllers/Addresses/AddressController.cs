...
namespace GadgetGrove.Api.Controllers.Addresses;
...
public class AddressController : BaseController
{
    ...
    [HttpPost]
    public async Task<IActionResult> InsertAsync([FromBody] AddressForCreationDto dto)
        => Ok(await _addressService.AddAsync(dto));
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> UpdateAsync([FromRoute] long id, [FromBody] AddressForCreationDto dto)
